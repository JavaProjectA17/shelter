<div class="bottom_block bot1">
    <div class="container_12">
        ...
        <div class="grid_4">
            <div class="pad2"> <img src="/user/images/page2_img9.jpg" alt="" class="img_inner fleft">
                <div class="extra_wrapper">
        ...
        <div class="grid_4">
            <div class="pad2"> <img src="/user/images/page2_img10.jpg" alt="" class="img_inner fleft">
                <div class="extra_wrapper">
