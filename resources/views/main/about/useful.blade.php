<div class="content">
    <div class="container_12">
        ...
        <div class="grid_4">
            <div class="pad2"> <img src="/user/images/page2_img4.jpg" alt="" class="img_inner fleft i2">
                <div class="extra_wrapper">
        ...
        <div class="grid_4">
            <div class="pad2"> <img src="/user/images/page2_img5.jpg" alt="" class="img_inner fleft i2">
                <div class="extra_wrapper">
        ...
        <div class="grid_4">
            <div class="pad2"> <img src="/user/images/page2_img6.jpg" alt="" class="img_inner fleft i2">
                <div class="extra_wrapper">
        ...
        <div class="grid_4">
            <div class="pad2"><img src="/user/images/page2_img7.jpg" alt="" class="img_inner fleft i2">
                <div class="extra_wrapper">
