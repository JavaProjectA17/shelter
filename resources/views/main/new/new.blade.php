<div class="grid_7">
    ...
    <div class="blog"> <img src="/user/images/page4_img2.jpg" alt="" class="img_inner fleft i1">
        <div class="extra_wrapper">
        ...
        <a href="#" class="btn">More</a> </div>
    <div class="blog"> <img src="/user/images/page4_img3.jpg" alt="" class="img_inner fleft i1">
        <div class="extra_wrapper">
        ...
        <a href="#" class="btn">More</a> </div>
    <div class="blog"> <img src="/user/images/page4_img4.jpg" alt="" class="img_inner fleft i1">
        <div class="extra_wrapper">
