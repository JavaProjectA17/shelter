<div class="bottom_block">
    <div class="container_12">
        ...
        <div class="grid_4 prefix_2">
            <h2 class="ic1">Будь-яке питання?</h2>
            <img src="user/images/page1_img4.jpg" alt="" class="fleft img_inner">
            <div class="extra_wrapper">
                <div class="cont"> Зателефонуйте нам : <span> 063-189-22-56</span> </div>
            </div>
            <div class="clear"></div>
